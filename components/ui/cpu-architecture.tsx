...
export interface CpuArchitectureSvgProps {
  ...
  nodeLabels?: { text: string; color: string }[];
}
  ...
  return (
    ...
    >
      ...
      >
        {/* 1st */}
        <path
          className="cpu-wire-flow cpu-wire-flow-1"
          d="M 10 20 h 79.5 q 5 0 5 5 v 30"
        />
        {/* 2nd */}
        <path
          className="cpu-wire-flow cpu-wire-flow-2"
          d="M 180 10 h -69.7 q -5 0 -5 5 v 30"
        />
        {/* 3rd */}
        <path
          className="cpu-wire-flow cpu-wire-flow-3"
          d="M 130 20 v 21.8 q 0 5 -5 5 h -10"
        />
        {/* 4th */}
        <path
          className="cpu-wire-flow cpu-wire-flow-4"
          d="M 170 80 v -21.8 q 0 -5 -5 -5 h -50"
        />
        {/* 5th */}
        <path
          className="cpu-wire-flow cpu-wire-flow-5"
          d="M 135 65 h 15 q 5 0 5 5 v 10 q 0 5 -5 5 h -39.8 q -5 0 -5 -5 v -20"
        />
        {/* 6th */}
        <path
          className="cpu-wire-flow cpu-wire-flow-6"
          d="M 94.8 95 v -36"
        />
        {/* 7th */}
        <path
          className="cpu-wire-flow cpu-wire-flow-7"
          d="M 88 88 v -15 q 0 -5 -5 -5 h -10 q -5 0 -5 -5 v -5 q 0 -5 5 -5 h 14"
        />
        {/* 8th */}
        <path
          className="cpu-wire-flow cpu-wire-flow-8"
      ...
      <g mask="url(#cpu-mask-1)">
        <circle className="cpu-architecture cpu-line-1" cx="0" cy="0" r="12" fill="url(#cpu-blue-grad)" />
      </g>
      {/* 2. Yellow Light */}
      <g mask="url(#cpu-mask-2)">
        <circle className="cpu-architecture cpu-line-2" cx="0" cy="0" r="12" fill="url(#cpu-yellow-grad)" />
      </g>
      {/* 3. Pinkish Light */}
      <g mask="url(#cpu-mask-3)">
        <circle className="cpu-architecture cpu-line-3" cx="0" cy="0" r="12" fill="url(#cpu-pinkish-grad)" />
      </g>
      {/* 4. White Light */}
      <g mask="url(#cpu-mask-4)">
        <circle className="cpu-architecture cpu-line-4" cx="0" cy="0" r="12" fill="url(#cpu-white-grad)" />
      </g>
      {/* 5. Green Light */}
      <g mask="url(#cpu-mask-5)">
        <circle className="cpu-architecture cpu-line-5" cx="0" cy="0" r="12" fill="url(#cpu-green-grad)" />
      </g>
      {/* 6. Orange Light */}
      <g mask="url(#cpu-mask-6)">
        <circle className="cpu-architecture cpu-line-6" cx="0" cy="0" r="12" fill="url(#cpu-orange-grad)" />
      </g>
      {/* 7. Cyan Light */}
      <g mask="url(#cpu-mask-7)">
        <circle className="cpu-architecture cpu-line-7" cx="0" cy="0" r="12" fill="url(#cpu-cyan-grad)" />
      </g>
      {/* 8. Rose Light */}
      <g mask="url(#cpu-mask-8)">
        <circle className="cpu-architecture cpu-line-8" cx="0" cy="0" r="12" fill="url(#cpu-rose-grad)" />
      </g>
      {/* CPU Box */}
      <g>
        {/* Cpu connections */}
      ...
      {nodeLabels && (
        <g fontFamily="monospace">
          {nodeLabels.slice(0, 8).map((label, i) => {
            ...
            return (
              <text
                ...
                fontSize="3.5"
                fill={label.color}
                textAnchor={pos.anchor as "start" | "end" | "middle"}
                opacity="0.85"
                fontWeight="500"
              >
                {label.text}
      ...
      <defs>
        ...
        <mask id="cpu-mask-3">
          <path
            d="M 130 20 v 21.8 q 0 5 -5 5 h -25"
            strokeWidth="0.5"
            stroke="white"
          />
        </mask>
        <mask id="cpu-mask-4">
          <path
            d="M 170 80 v -21.8 q 0 -5 -5 -5 h -65"
            strokeWidth="0.5"
            stroke="white"
          />
        </mask>
